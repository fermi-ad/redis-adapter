...
static void Benchmark_AddList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_list_key", values);
    }
}
...
static void Benchmark_Get1KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_1kb_list_key", small_list);  // Pre-add data
...
static void Benchmark_Add2KBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_2kb_list_key", list_2kb);
    }
}
...
static void Benchmark_Get2KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_2kb_list_key", list_2kb);  // Pre-add data
...
static void Benchmark_Add5KBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_5kb_list_key", list_5kb);
    }
}
...
static void Benchmark_Get5KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_5kb_list_key", list_5kb);  // Pre-add data
...
static void Benchmark_Add10KBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_10kb_list_key", list_10kb);
    }
}
...
static void Benchmark_Get10KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_10kb_list_key", list_10kb);  // Pre-add data
...
static void Benchmark_Add250KBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_250kb_list_key", mid_list);
    }
}
...
static void Benchmark_Get250KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_250kb_list_key", mid_list);  // Pre-add data
...
static void Benchmark_Add500KBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_500kb_list_key", list_500kb);
    }
}
...
static void Benchmark_Get500KBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_500kb_list_key", list_500kb);  // Pre-add data
...
static void Benchmark_Add1MBList(benchmark::State& state) {
    ...
    for (auto _ : state) {
        redis.addSingleList("benchmark_1mb_list_key", large_list);
    }
}
...
static void Benchmark_Get1MBList(benchmark::State& state) {
    ...
    redis.addSingleList("benchmark_1mb_list_key", large_list);  // Pre-add data
